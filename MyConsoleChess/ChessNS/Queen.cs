...
namespace MyConsoleChess.ChessNS
{
    class Queen : Piece
    {
        public Queen(int row,int collum, Color color, Chess chess) : base(row, collum, color, chess)
        {
        }
        public Queen(char collum, int row, Color color, Chess chess) : base(collum, row, color, chess)
        {
        }
